  ...
  <div>
    <v-dialog v-model="show" >
      <v-card>
        ...
        <v-card-text>
          <v-form id="form" ref="form" v-model="valid" enctype="multipart/form-data" @submit.prevent="uploadPublication" >
            ...
            <v-btn type="submit" color="accent" rounded :loading="loading" :disabled="loading || !valid" :elevation="0" >
              save
            </v-btn>
          </v-form>
        </v-card-text>
